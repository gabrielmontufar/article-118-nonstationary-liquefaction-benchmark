...
The package also contains a CIVIL-NOVELTY-Q1-100 manuscript audit. The current evidence-bound CIVIL novelty score is 81/100 after adding a condensed close-literature frontier, explicit evidence-class separation, a falsifiability paragraph, and a control sentence stating what the community learns after this manuscript. The score is capped below 85 until the physical switch is directly confirmed by monitored temporal field evolution or another direct field/case-history test strong enough to remove the current evidence boundary.
